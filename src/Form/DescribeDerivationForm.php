<?php
 ...
 class DescribeDerivationForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state){
    ...
    if (isset($this->getElement()->namedGraph) && !empty($this->getElement()->namedGraph)) {
      $form['named_graph'] = [
        '#type' => 'item',
  ...
  if ($hascoType == VSTOI::INSTRUMENT || $hascoType == VSTOI::COMPONENT ) {
      ...
      if ($hascoType == VSTOI::COMPONENT) {
          ...
          $form['element_usage'] = [
              '#type' => 'item',
              '#title' => t(ListUsage::fromComponentToHtml($usageElements)),
          ];
      } else {
          $form['element_usage'] = [
              '#type' => 'item',
      ...
      if ($hascoType == VSTOI::COMPONENT) {
        ...
        $form['element_derivation'] = [
            '#type' => 'item',
            '#title' => t(ListDerivation::fromComponentToHtml($derivationElements)),
        ];
      } else {
        $form['element_derivation'] = [
            '#type' => 'item',
